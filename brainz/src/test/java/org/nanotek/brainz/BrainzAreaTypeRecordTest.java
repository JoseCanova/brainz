...
import org.nanotek.brainz.base.entity.AreaType;
import org.nanotek.brainz.base.repository.BaseTypeRepository; // you need to implement this
...
@SpringBootTest
class BrainzAreaTypeRecordTest {
    ...
    @Autowired
    BaseTypeRepository repository; // You need to implement BaseTypeRepository
    ...
    void setUp() throws Exception {
        ...
        configuration = theMap.get("area_type");
        assertNotNull(configuration);
    }

    @Test
    void test() {
        String file = configuration.getFileLocation().concat("/").concat(configuration.getFileName());
...
//        Optional<?> theIdOptional = repository.findByAreaType(3L); // areaType is the mapped field for type_id
//        theIdOptional
